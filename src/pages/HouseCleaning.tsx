...
const HouseCleaning = () => (
  <>
    <Seo
      title="House Cleaning Lowell MA & Merrimack Valley | Paiva Cleaners Co."
      description="Professional house cleaning in Lowell, Chelmsford, Dracut, Tewksbury, Billerica, and Westford. Get pricing in 60 seconds and book trusted insured cleaners."
      canonicalPath="/house-cleaning"
      keywords={[
        "house cleaning lowell ma",
        "house cleaning chelmsford ma",
        "maid service lowell",
        "recurring cleaning merrimack valley",
      ]}
      image={img}
      schema={{
        ...
        provider: { "@type": "LocalBusiness", name: "Paiva Cleaners Co." },
      }}
    />
    <ServicePageTemplate
      eyebrow="Residential"
      title="House Cleaning Services Built Around Your Home"
      description="Routine residential cleaning that keeps every room fresh, comfortable, and ready for life. Trained teams, consistent results, and flexible scheduling across Lowell and nearby communities."
      heroImage={img}
      included={[
        "Kitchen cleaning",
        "Bathroom cleaning",
